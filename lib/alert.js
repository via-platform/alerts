...
const url = 'http://localhost:4300/alerts';//'https://alerts.via.world/alerts';
...
module.exports = class Alert {
    ...
    initialize(params){
        ...
        this._direction = VALID_DIRECTIONS.includes(params.direction) ? params.direction : 'above';
    ...
    set value(value){
        ...
        this._value = (this.market && _.isNumber(value)) ? via.functions.truncate(value, this.market.precision[property]) : value;
    ...
    transmit(){
        ...
        return axios.post(url,
            {value: this.value, type: this.type, uuid: this.uuid, market: this.market.id, exchange: this.market.exchange.id, direction: this.direction},
